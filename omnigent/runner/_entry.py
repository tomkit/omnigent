...
def create_app(
    ...
    server_client = httpx.AsyncClient(
        ...
        # :func:`_server_client_headers`. The workspace-routing header
        # (``databricks_org_id_headers``, empty unless a ?o= selector was
        # recorded for this server) routes these callbacks to the workspace.
        headers={**_server_client_headers(), **databricks_request_headers(server_url)},
